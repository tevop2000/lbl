...
{
    public partial class DetailYearImportDialog : Window
    {
        private string? _selectedFilePath;
        private CancellationTokenSource? _loadingCts;
        private bool _isLoading;

        public DetailYearImportDialog()
        {
            InitializeComponent();
        ...
        private async void ConfirmButton_Click(object? sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                var response = await apiClient.PostAsync($"{AgentManagement.Avalonia.Utils.NewApiClient.BaseUrl}/rate/saletargetyear/importData", content);
